...
<html>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/into/z_into_banner.jsp"><jsp:param name="page" value="10" /></jsp:include>
        <!-- 主体 -->
            <div class="two-main">
                <!-- 左侧导航 -->
            <jsp:include page="/WEB-INF/into/z_left.jsp"><jsp:param name="page" value="10" /></jsp:include>
                <!-- 左侧导航 end -->
                <!-- 右侧内容 -->
                <div class="fm-list">
