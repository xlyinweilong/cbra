...
<html>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/into/z_into_banner.jsp"><jsp:param name="page" value="14" /></jsp:include>
            <!-- 主体 -->
            <div class="two-main">
                <!-- 左侧导航 -->
            <jsp:include page="/WEB-INF/into/z_left.jsp"><jsp:param name="page" value="14" /></jsp:include>
                <!-- 左侧导航 end -->
                <!-- 右侧内容 -->
                <div class="fm-list">
                    <div class="title"><span><a id="title-span"><fmt:message key="INDEX_建筑产业化" bundle="${bundle}"/></a></span></div>
                    <form id="form1" action="/into/industrialization" method="post">
                            ...
                            <li>
                                ...
                                <div class="con"><a href="/into/details?id=${plateInformation.id}" target="_blank">
                                    ...
                                    <p class="p2"><%--<span class="span1"><a href="#">[筑誉动态]</a></span>--%><span>
                                        ...
                                        </span><span class="span2"><a href="/into/details?id=${plateInformation.id}" target="_blank" >[<fmt:message key="GLOBAL_阅读全文" bundle="${bundle}"/>]</a></span></p>
                                </div>
