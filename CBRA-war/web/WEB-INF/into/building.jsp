...
<html>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/into/z_into_banner.jsp"><jsp:param name="page" value="11" /></jsp:include>
            <!-- 主体 -->
            <div class="two-main">
                <!-- 左侧导航 -->
            <jsp:include page="/WEB-INF/into/z_left.jsp"><jsp:param name="page" value="11" /></jsp:include>
                <!-- 左侧导航 end -->
                <!-- 右侧内容 -->
                <div class="fm-list">
                    <div class="title"><span><a id="title-span"><fmt:message key="INDEX_建筑产业化合作" bundle="${bundle}"/></a></span></div>
                    <form id="form1" action="/into/building" method="post">
