<%-- 
    Document   : un_processed_seal_list
    Created on : May 27, 2011, 4:03:43 PM
    Author     : WangShuai
--%>
...
<%
    ...
    request.setAttribute("subMenuSelection", "SEAL_UN_PROCESSED");
%>

<%@include file="/WEB-INF/support/z_header.jsp"%>

<jsp:include page="/WEB-INF/support/z_date_form.jsp">
    <jsp:param name="action" value="/support/un_processed_seal_list" />
    <jsp:param name="title" value="未处理实名认证：" />
</jsp:include>
