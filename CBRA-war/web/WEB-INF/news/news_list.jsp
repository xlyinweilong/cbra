                ...
                <div class="news-list">
                    ...
                    <ul>
                        <c:forEach var="plateInformation" items="${resultList}">
                            <li>
                                <div class="img"><a href="/news/details?id=${plateInformation.id}" target="_blank"><img style="width: 140px; height: 100px;" src="<c:if test="${not empty plateInformation.picUrl}">${plateInformation.picUrl}</c:if><c:if test="${empty plateInformation.picUrl}">/ls/ls-19.jpg</c:if>"></a></div>
