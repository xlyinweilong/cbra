    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/news/z_news_banner.jsp"><jsp:param name="page" value="2" /></jsp:include>
            ...
            <div class="two-main">
                ...
                <div class="news-list">
                    <div class="title"><span><a href="/news/news_list"><fmt:message key="INDEX_筑誉新闻" bundle="${bundle}"/></a></span><span><a id="title-span" href="/news/industry_list"><fmt:message key="INDEX_行业新闻" bundle="${bundle}"/></a></span></div>
                    <ul>
