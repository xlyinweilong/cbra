...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var zNodes =[
		    		{id:'0', pId:'0', name:"菜单列表", open:true, url:"./menuAction!showMenuList.action?parentKey=0", target : "listFrame"}
		    		<s:iterator value="menuList">
		    		,{id:'<s:property value="menuKey"/>', pId:'<s:property value="parentKey"/>', name:"<s:property value="menuName" escape="false"/>", open:true, url:"./menuAction!showMenuList.action?parentKey=<s:property value="menuKey"/>", target: "listFrame"}
		    		</s:iterator>
		    	];
