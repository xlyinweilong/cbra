...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var zNodes =[
		    		{id:'0', pId:'0', name:"公司列表", open:true, url:"./openDeptmentAction.action?companyId=0", target : "listFrame"}
		    		...
		    		,{id:'<s:property value="id"/>', pId:'<s:property value="regionId"/>', name:"<s:property value="companyName" escape="false"/>", open:true, url:"./openDeptmentAction.action?companyId=<s:property value="id"/>", target: "listFrame",icon:"<%=path %>/admin/js/zTreeStyle/img/diy/company.png"}
		    		</s:iterator>
		    	];
