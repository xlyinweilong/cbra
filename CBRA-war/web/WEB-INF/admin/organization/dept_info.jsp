...
<script type="text/javascript">
	$(function() {
  		...
  		$("#saveBtn").click(function() {
			var rules={
				"dept.deptName": {required: true}
			};
			var messages={
				"dept.deptName": {required: "部门名称必须填写！"}
			};
			//初始化验证框架
			FormSave("form1",rules, messages);
			$("#form1").attr("target", "iframe1");
			$("#form1").attr("action", "saveOrUpdateDeptAction.action");
            $("#form1").submit();
        });
  		$.fn.goback();
  	});
...
<body>
	...
	<s:form id="form1" name="form1" method="post" theme="simple">
		...
		<s:hidden id="deptId" name="dept.id"></s:hidden>
	    <ul class="forminfo">
	    <li><label>部门名称<b>*</b></label><s:textfield id="txt_deptName" name="dept.deptName" cssClass="dfinput" cssStyle="width: 350px;" maxlength="25"></s:textfield><i>部门名称不能超过25个汉字，必填项</i></li>
	    <li><label>部门电话</label><s:textfield id="txt_phone" name="dept.phone" cssClass="dfinput" cssStyle="width: 350px;" maxlength="25"></s:textfield><i></i></li>
	    <li><label>&nbsp;</label>
