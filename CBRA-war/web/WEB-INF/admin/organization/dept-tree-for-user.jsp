...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var zNodes =[
		    		{id:'0', pId:'0', name:"部门列表", open:true, url:"", target : "listFrame"}
		    		<s:iterator value="regionList">
		    		,{id:'<s:property value="id"/>', pId:'<s:property value="parentId"/>', name:"<s:property value="name" escape="false"/>", open:true, url:"", target: "",icon:"<%=path %>/admin/js/zTreeStyle/img/diy/city.png"}
		    		</s:iterator>
		    		<s:iterator value="companyList">
		    		,{id:'<s:property value="id"/>', pId:'<s:property value="regionId"/>', name:"<s:property value="companyName" escape="false"/>", open:true, url:"", target: "listFrame",icon:"<%=path %>/admin/js/zTreeStyle/img/diy/company.png"}
		    		</s:iterator>
		    		<s:iterator value="deptList">
		    		,{id:'<s:property value="id"/>', pId:'<s:property value="companyId"/>', name:"<s:property value="deptName" escape="false"/>", open:true, url:"./userAction!showUserList.action?deptId=<s:property value="id"/>", target: "listFrame",icon:"<%=path %>/admin/js/zTreeStyle/img/diy/group.png"}
		    		</s:iterator>
		    	];
