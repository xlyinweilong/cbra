	...
	<head>
		...
		$(function(){
			...
			$("#addBtn").click(function(){
				window.location.href="./openAddRoleAction.action";
			});
			
			//删除所选设备信息
			$("#deleteBtn").click(function(){
				$.fn.delete_items("ids","./deleteRoleAction.action");
			});
		...
		$.fn.edit = function(sid){
			window.location.href="./openModifyRoleAction.action?role.id=" + sid;
		};
		//删除单个设备信息
		$.fn.deleteItem = function(sid){
			//$(".tip").fadeIn(200);
			//$(".tip").fadeOut(100);
			var url = "./deleteRoleAction.action?ids="+sid;
