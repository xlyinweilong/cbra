...
<body>
	...
	<div class="place">
		...
		<table style="width:100%;">
			<tr>
				<td style="border-right: 1px solid #dedede;width:200px;"><iframe id="treeFrame" name="treeFrame" src="./regionAction!showRegionTreeForCompany.action" frameborder="0" scrolling="auto" style="width:100%; height:100%"></iframe></td>
