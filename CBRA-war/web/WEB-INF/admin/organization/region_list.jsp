...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(function() {
		...
		$("#addBtn")
				.click(
						function() {
							window.location.href = "./regionAction!showRegionInfo.action?region.id=&parentId=<s:property value="parentId"/>";
						});

		//删除所选设备信息
		$("#deleteBtn").click(function() {
			$.fn.delete_items("ids", "./regionAction!deleteRegion.action");
			$.fn.refreshtree();
		});
	...
	$.fn.edit = function(sid) {
		window.location.href = "./regionAction!showRegionInfo.action?region.id="
				+ sid + "&parentId=<s:property value="parentId"/>";
	};
	//删除单个设备信息
	$.fn.deleteItem = function(sid) {
		var url = "./regionAction!deleteRegion.action?ids=" + sid;
