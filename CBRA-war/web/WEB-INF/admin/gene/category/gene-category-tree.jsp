...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var zNodes =[
		    		{id:'0', pId:'0', name:"分类列表", open:true, url:"./geneCategoryAction!showGeneCategoryList.action?parentId=0", target : "listFrame"}
		    		<s:iterator value="geneCategoryList">
		    		,{id:'<s:property value="id"/>', pId:'<s:property value="parentId"/>', name:"<s:property value="name" escape="false"/>", open:true, url:"./geneCategoryAction!showGeneCategoryList.action?parentId=<s:property value="id"/>", target: "listFrame",icon:"<%=path %>/admin/js/zTreeStyle/img/diy/city.png"}
		    		</s:iterator>
		    	];
