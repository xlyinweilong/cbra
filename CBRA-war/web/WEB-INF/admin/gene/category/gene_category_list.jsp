...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(function() {
		...
		$("#addBtn")
				.click(
						function() {
							window.location.href = "./geneCategoryAction!showGeneCategoryInfo.action?geneCategory.id=&parentId=<s:property value="parentId"/>";
						});

		//删除所选设备信息
		$("#deleteBtn").click(function() {
			$.fn.delete_items("ids", "./geneCategoryAction!deleteGeneCategory.action");
			$.fn.refreshtree();
		});
	...
	$.fn.edit = function(sid) {
		window.location.href = "./geneCategoryAction!showGeneCategoryInfo.action?geneCategory.id="
				+ sid + "&parentId=<s:property value="parentId"/>";
	};
	//删除单个设备信息
	$.fn.deleteItem = function(sid) {
		var url = "./geneCategoryAction!deleteGeneCategory.action?ids=" + sid;
