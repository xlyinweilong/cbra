...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$(function() {
		...
		$("#addBtn").click(function() {
			window.location.href = "./geneAction!showGeneInfo.action?geneCategoryId=<s:property value="geneCategoryId"/>";
		});
		//删除所选设备信息
		$("#deleteBtn").click(function() {
			$.fn.delete_items("ids", "./geneAction!deleteGene.action");
		});
	...
	$.fn.edit = function(sid) {
		window.location.href = "./geneAction!showGeneInfo.action?gene.id="
				+ sid + "&geneCategoryId=<s:property value="geneCategoryId"/>";
	};
	//删除单个设备信息
	$.fn.deleteItem = function(sid) {
		var url = "./geneAction!deleteGene.action?ids=" + sid;
					...
					<tbody>
						<s:iterator value="pagination.data" status="obj">
							<tr>
								...
								<td>
									<s:if test="fileUrl != null">
										<a href="<%=path%>/<s:property value="fileUrl"/>"
											target="_blank" class="tablelink">预览</a>
									</s:if>
								</td>
								<td>
