...
function tipsWindown(title,content,width,height,drag,time,showbg,cssName,scrolling) {
	...
	var width = width>= 1000?this.width=1000:this.width=width;	    //设置最大窗口宽度
	...
	if( height >= 527 ) {
		...
		$("#windown-content").css({width:(parseInt(width)+22)+"px",height:height+"px"});
	}else {
		$("#windown-title").css({width:(parseInt(width)+10)+"px"});
		//$("#windown-content").css({width:width+"px",height:height+"px"});
		$("#windown-content").css({width:(parseInt(width)+10)+"px",height:height+"px"});
	}
