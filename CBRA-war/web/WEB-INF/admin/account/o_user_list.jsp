    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $.fn.edit = function (sid) {
                window.location.href = "/admin/account/o_user_info?id=" + sid;
            };
            //删除单个设备信息
            $.fn.deleteItem = function (sid) {
                var url = "/admin/account/o_user_list?a=ACCOUNT_DELETE&ids=" + sid;
                    ...
                    <tbody>
                        <c:forEach var="user" items="${resultList}">
                            <tr>
                                ...
                                <td>
                                    <fmt:formatDate value="${user.createDate}" pattern="yyyy.MM.dd HH:mm:ss" type="date" dateStyle="long" />
                                </td>
                                <td>
