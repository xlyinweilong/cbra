<%-- 
    Document   : create
    Created on : Sep 7, 2012, 1:58:41 PM
    Author     : wangshuai
--%>
...
<div class="BlueBox">
    <div class="BlueBoxTitle">
        <fmt:message key="ADD_FUND_充值说明" bundle="${bundle}"/> 
    </div>
    <div class="noticeMessage" style="display:none">
        <div class="successMessage" style="display:none"></div>
        <div class="wrongMessage" style="display:none" id="addfund_wrong_msg_container"></div>
        <div class="loadingMessage" style="display:none" id="addfund_loading_container"><fmt:message key="GLOBAL_MSG_LOADING" bundle="${bundle}"/><img alt="" src="/images/032.gif"></div>
    </div>
    <div class="BlueBoxContent">
        
        <form method="POST" id="add_fund_form" action="/addfund/create/" onsubmit="return FundAddFund.checkForm();" target="_blank">
            <div style="background:#EFEFEF; padding: 10px 0px; margin-top:30px;">
                <div class="sk-item  TextAlignLeft">
                    <label class="sk-label"><b><fmt:message key="ADD_FUND_充值金额" bundle="${bundle}"/></b></label>
                    <input type="text" name="amount" id="payment_amount" class="Input200" style="margin-left: 5px;"/>
                    <fmt:message key="GLOBAL_元/人民币" bundle="${bundle}"/>
                </div>
            ...
            <div> <div class="charge_form" id="credit_card_input_div" style="display: none">
                ...
                <input type="hidden" name="urlUserWantToAccess" value="/addfund/create" />
            </div>

            <div >  
                <input type="submit" id="payment_btn" value="<fmt:message key='ADD_FUND_充值' bundle='${bundle}'/>" class="collection_button FloatRight MarginL7 MarginTop20"/>
...
<script type="text/javascript">
    ...
    function(){
        ...
        GatewayPayment.initGatewaySelect("add_fund",${rateCNY2USD},${rateUSD2CNY});
...
<c:set var="scriptVarName" value="FundAddFund"></c:set>
