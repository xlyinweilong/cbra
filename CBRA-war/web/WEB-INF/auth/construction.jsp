    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/auth/z_auth_banner.jsp"><jsp:param name="page" value="1" /></jsp:include>
            ...
            <jsp:include page="/WEB-INF/auth/z_left.jsp"><jsp:param name="page" value="1" /></jsp:include>
                ...
                <!-- 右侧内容 -->
                <div class="fr-con">
                    <div class="title"><span><a href="/auth/design">设　　计</a></span><span><a href="/auth/construction" id="title-span">施　　工</a></span><span><a href="/auth/quality">质　　量</a></span><span><a href="/auth/safe">安　　全</a></span></div>
