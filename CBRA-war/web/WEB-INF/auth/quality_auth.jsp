    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/auth/z_auth_banner.jsp"><jsp:param name="page" value="2" /></jsp:include>
            ...
            <jsp:include page="/WEB-INF/auth/z_left.jsp"><jsp:param name="page" value="2" /></jsp:include>
                ...
                <!-- 右侧内容 -->
                <div class="fr-con">
                    <div class="title"><span><a href="/auth/quality_auth" id="title-span"><fmt:message key="INDEX_品质认证" bundle="${bundle}"/></a></span><span><a href="/auth/safe_auth"><fmt:message key="INDEX_安全认证" bundle="${bundle}"/></a></span></div>
