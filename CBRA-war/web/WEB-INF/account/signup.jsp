            ...
            <div class="Title"><a href="/account/signup" id="ind-reg-b">个人入会申请</a><a href="/account/signup_c">企业入会申请</a></div>
                ...
                <div id="step2" style="display: none">
                    ...
                    <table width="914" border="0" style="margin:0 auto; border-bottom:2px #dddddd solid; padding-bottom:20px;">
                        <tr>
                        <form id="reg_front_form" method="post" enctype="multipart/form-data" target="iframe1" action="/account/z_iframe_upload_pc">
                            <input type="hidden" name="a" value="upload_person_card" />
                            <input type="hidden" name="type" value="front" />
                            <td align="center" style="width:457px;"><div id="reg_front_div" class="reg-img"><br><br><br><p>上传身份证正面</p><p>上传图片大小不得超过200K
                                        支持JPG、PNG图片格式</p><input id="reg_front_button" type="button" style=" width:98px; height:26px; background:#bbbbbb; color:#FFF; border:0; border-radius:5px; cursor:pointer;" value="选择图片路径">
                                    <p id="reg_front_result"></p>
                                </div><input id="reg_front_submit" type="button" style=" width:110px; height:32px; background:#52853d; color:#FFF; border:0; border-radius:5px; cursor:pointer;" value="上传图片">
                        ...
                        <form id="reg_back_form" method="post" enctype="multipart/form-data" target="iframe1" action="/account/signup">
                            <input type="hidden" name="a" value="upload_person_card"  />
                            <input type="hidden" name="type" value="back" />
                            <td id="reg_back_td" align="center" style="width:457px;">
                                <div class="reg-img"><br><br><br><p>上传身份证背面</p><p>上传图片大小不得超过200K
                                        支持JPG、PNG图片格式</p><input id="reg_back_button" type="button" style=" width:98px; height:26px; background:#bbbbbb; color:#FFF; border:0; border-radius:5px; cursor:pointer;" value="选择图片路径">
                                    <p id="reg_back_result"></p>
                                </div><input id="reg_back_submit" type="button" style=" width:110px; height:32px; background:#52853d; color:#FFF; border:0; border-radius:5px; cursor:pointer;" value="上传图片">
                ...
                <div id="step3" style="display: none">
                    ...
                    <table width="914" border="0" style="margin:0 auto; border-bottom:2px #dddddd solid; padding-bottom:20px;">
                        <tr>
                            <td align="center" ><textarea style="width:910px; height:150px; border:1px #e6e6e6 solid;"></textarea></td>
                        </tr>
                    </table>
                    <table width="914" border="0" style="margin:20px auto; padding-bottom:20px;">
                        <tr>
                    ...
                    <table width="914" border="0" style="margin:20px auto; padding-bottom:20px;">
                        <tr>
                            <td align="center" >
                                ...
                                <input type="button" style=" width:130px; height:42px; background:#52853d; color:#FFF; border:0; border-radius:5px; font-size:14px; cursor:pointer;" value="提 交" />
                            </td>
                        </tr>
                    </table>
                </div>
