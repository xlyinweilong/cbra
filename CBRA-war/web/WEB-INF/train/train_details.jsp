...
<html>
    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/train/z_train_banner.jsp"><jsp:param name="page" value="4" /></jsp:include>
            <!-- 主体 -->
            <div class="two-main">
                <!-- 左侧导航 -->
            <jsp:include page="/WEB-INF/train/z_left.jsp"><jsp:param name="page" value="4" /></jsp:include>
                <!-- 左侧导航 end -->
                <!-- 右侧内容 -->
                <div class="fm-list">
